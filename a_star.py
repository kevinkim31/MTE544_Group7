...
def search(maze, start, end, heuristic_type='euclidean'):
    ...
    while len(yet_to_visit_dict) > 0:
        ...
        for child in children:
            ...
            # Calculate g cost: parent's g + movement cost
            # Check if its a diagonal move (both x and y change) or cardinal move (only one changes)
            ...
            # Heuristic costs calculated here, using selected heuristic (euclidean or manhattan)
